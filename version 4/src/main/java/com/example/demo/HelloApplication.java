...
//updates entire cube (To be applied after scrambles)
    ...
    public void start(Stage stage) {
        ...
        //String[] scramble = {"D"};
        //String[] scramble = {"U2","L","U'","R","F","D'","R2","L","B2","U2","L'","B","U","L'","B'","L'","D2","R","F'","B"};
        ...
        //Thread thistle = new Thread(new Thistle(cube,perms, simplified, cubeGUI, colours, duration));
        //thistle is operated in a separate thread as this means that you can run the GUI in the background without it pausing
        //thistle.start();
        Thread beginner = new Thread(new Beginners(cube,cubeGUI,colours, duration));
        beginner.start();
        //Thread CFOP = new Thread(new CFOP(cube, cubeGUI, colours, duration));
        //CFOP.start();
    }
