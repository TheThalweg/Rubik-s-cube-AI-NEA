...
public class Thistle implements Runnable{
    ...
    public Thistle(Cube initial, HashSet<Long> perms, Cube simplified, Label moveDisplay, Color[] colours, float duration, String[] solutionContainer, CyclicBarrier barrier){
    ...
    public void run(){
        ...
        try {
            ...
            solutionContainer[0] = stringSolution;
            try {
