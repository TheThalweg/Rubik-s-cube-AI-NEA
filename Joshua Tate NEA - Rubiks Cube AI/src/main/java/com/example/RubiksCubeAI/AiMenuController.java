...
public class AiMenuController{
    ...
    @FXML
    public void handleCFOPButtonAction() throws IOException, BrokenBarrierException, InterruptedException {
        AudioClip click = new AudioClip(Objects.requireNonNull(getClass().getResource("/click.mp3")).toExternalForm());
        click.play();
    ...
    @FXML
    public void handleBeginnerButtonAction() throws IOException, BrokenBarrierException, InterruptedException {
        AudioClip click = new AudioClip(Objects.requireNonNull(getClass().getResource("/click.mp3")).toExternalForm());
        click.play();
        // Load the new FXML file
        FXMLLoader loader = new FXMLLoader(getClass().getResource("cubeScene.fxml"));
    ...
    @FXML
    public void handleThistleButtonAction() throws IOException, BrokenBarrierException, InterruptedException {
        AudioClip click = new AudioClip(Objects.requireNonNull(getClass().getResource("/click.mp3")).toExternalForm());
        click.play();
        // Load the new FXML file
        FXMLLoader loader = new FXMLLoader(getClass().getResource("cubeScene.fxml"));
