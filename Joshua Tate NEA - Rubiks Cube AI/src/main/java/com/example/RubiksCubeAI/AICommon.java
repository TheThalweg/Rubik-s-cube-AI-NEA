...
most optimal (using the algorithms I chose) solution*/
    ...
    public AICommon(Cube cube, Color[] colours, CubeController cubeController){
        this.cube = cube;
        this.colours = colours;
        this.cubeController = cubeController;
    }

    // Shifts moves according to the passed in parameter. shift is the value moves are to be moved to the right
            ...
            switch(whiteIndex%8){
                ...
                case 1 -> {
                    switch((((whiteIndex/8)-(colour-1))%4+4)%4){
                        ...
                        case 0 -> {if (cube.getColour((whiteIndex/8)%4+1,5)== disturbedColourRightFace &&cube.getColour(5,((whiteIndex/8)*2-1))==6)
                        ...
                        //other side
                        case 2 -> {if(cube.getColour((whiteIndex/8)%4+1,5)== disturbedColourRightFace &&cube.getColour(5,((whiteIndex/8)*2-1))==6){return performMoves(cube,"U' L F' L'",sequence,colour-1);}
